(function () {
  // Blocs.js Minified
  function $044eff482b0171691773d2fc1448d138$var$setUpSpecialNavs() {
    ($(".navbar-toggle").click(function (t) {
      var e = $(this).closest("nav"), i = e.find("ul.site-navigation"), a = i.clone();
      if (i.parent().hasClass("nav-special")) if ((t.stopPropagation(), $(this).hasClass("selected-nav"))) ($(".blocsapp-special-menu blocsnav").removeClass("open"), $(".selected-nav").removeClass("selected-nav"), setTimeout(function () {
        ...
        var o = e.attr("class").replace("navbar", "").replace("row", ""), l = i.parent().attr("class").replace("navbar-collapse", "").replace("collapse", "");
  ...
  function $044eff482b0171691773d2fc1448d138$var$extraNavFuncs() {
  ...
  function $044eff482b0171691773d2fc1448d138$var$setFillScreenBlocHeight() {
    $(".bloc-fill-screen").each(function (t) {
      ...
      }), $(this).css("height", $044eff482b0171691773d2fc1448d138$var$getFillHeight() + "px"));
    });
  }
  function $044eff482b0171691773d2fc1448d138$var$getFillHeight() {
    var t = $(window).height();
    return (t < fillBodyHeight && (t = fillBodyHeight + 100), t);
  }
  function $044eff482b0171691773d2fc1448d138$var$scrollToTarget(t) {
  ...
  function $044eff482b0171691773d2fc1448d138$var$animateWhenVisible() {
    ($044eff482b0171691773d2fc1448d138$var$hideAll(), $044eff482b0171691773d2fc1448d138$var$inViewCheck(), $(window).scroll(function () {
      ($044eff482b0171691773d2fc1448d138$var$inViewCheck(), $044eff482b0171691773d2fc1448d138$var$scrollToTopView(), $044eff482b0171691773d2fc1448d138$var$stickyNavToggle());
    }));
  }
  function $044eff482b0171691773d2fc1448d138$var$setUpDropdownSubs() {
  ...
  function $044eff482b0171691773d2fc1448d138$var$stickyNavToggle() {
    var t = 0, e = "sticky";
  ...
  function $044eff482b0171691773d2fc1448d138$var$hideAll() {
    $(".animated").each(function (t) {
      $(this).closest(".hero").length || $(this).removeClass("animated").addClass("hideMe");
    });
  }
  function $044eff482b0171691773d2fc1448d138$var$inViewCheck() {
    $($(".hideMe").get().reverse()).each(function (t) {
      var e = jQuery(this), i = e.offset().top + e.height(), a = $(window).scrollTop() + $(window).height();
  ...
  function $044eff482b0171691773d2fc1448d138$var$scrollToTopView() {
  ...
  function $044eff482b0171691773d2fc1448d138$var$setUpVisibilityToggle() {
  ...
  function $044eff482b0171691773d2fc1448d138$var$setUpLightBox() {
    (window.targetLightbox, $(document).on("click", "[data-lightbox]", function (t) {
      (t.preventDefault(), targetLightbox = $(this));
      var e = targetLightbox.attr("data-lightbox"), i = targetLightbox.attr("data-autoplay"), a = '<p class="lightbox-caption">' + targetLightbox.attr("data-caption") + "</p>", o = "no-gallery-set", l = targetLightbox.attr("data-frame");
  ...
  function $044eff482b0171691773d2fc1448d138$var$addSwipeSupport() {
  ...
  function $044eff482b0171691773d2fc1448d138$var$addKeyBoardSupport() {
    $(window).keydown(function (t) {
      37 == t.which ? $(".prev-lightbox").is(":visible") && $(".prev-lightbox").click() : 39 == t.which && $(".next-lightbox").is(":visible") && $(".next-lightbox").click();
    });
  }
  function $044eff482b0171691773d2fc1448d138$var$addLightBoxSwipeSupport() {
  ...
  ($(document).ready(function () {
    ...
    }), $044eff482b0171691773d2fc1448d138$var$extraNavFuncs(), $044eff482b0171691773d2fc1448d138$var$setUpSpecialNavs(), $044eff482b0171691773d2fc1448d138$var$setUpDropdownSubs(), $044eff482b0171691773d2fc1448d138$var$setUpLightBox(), $044eff482b0171691773d2fc1448d138$var$setUpVisibilityToggle(), $044eff482b0171691773d2fc1448d138$var$addSwipeSupport(), $044eff482b0171691773d2fc1448d138$var$addKeyBoardSupport(), -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") && $("#page-loading-blocs-notifaction").remove());
  }), $(window).load(function () {
    ($044eff482b0171691773d2fc1448d138$var$setFillScreenBlocHeight(), $044eff482b0171691773d2fc1448d138$var$animateWhenVisible(), $("#page-loading-blocs-notifaction").remove());
  }).resize(function () {
    $044eff482b0171691773d2fc1448d138$var$setFillScreenBlocHeight();
  }), $(function () {
