(function () {
  // ASSET: src/js/gmaps.js
  var $6c702ee657e7812dd94fbc8602658275$exports = {};
  var $6c702ee657e7812dd94fbc8602658275$var$define;
  (function (root, factory) {
    if (typeof $6c702ee657e7812dd94fbc8602658275$exports === 'object') {
      $6c702ee657e7812dd94fbc8602658275$exports = factory();
    } else if (typeof $6c702ee657e7812dd94fbc8602658275$var$define === 'function' && $6c702ee657e7812dd94fbc8602658275$var$define.amd) {
      $6c702ee657e7812dd94fbc8602658275$var$define(['jquery', 'googlemaps!'], factory);
    } else {
      root.GMaps = factory();
    }
  })($6c702ee657e7812dd94fbc8602658275$exports, function () {
    /*!
    * GMaps.js v0.4.25
    ...
    */
...
} else // New marker without styles
          {
    ...
    GMaps.createPanorama = function (options) {
      ...
      delete options.lat;
      delete options.lng;
      var streetview_events = ['closeclick', 'links_changed', 'pano_changed', 'position_changed', 'pov_changed', 'resize', 'visible_changed'], streetview_options = extend_object({
        visible: true
      }, options);
