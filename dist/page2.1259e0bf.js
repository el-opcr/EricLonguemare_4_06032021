  ...
  (function ($) {
    ...
    var defaults = {
      ...
      methods: {
        init: function (options) {
          ...
          $(uniqueForms).bind("submit", function (e) {
            ...
            $inputs.each(function (i, el) {
              var $this = $(el), $controlGroup = $this.parents(".form-group, .checkbox").first();
          ...
          return this.each(function () {
            ...
            var $this = $(this), $controlGroup = $this.parents(".form-group, .checkbox").first(), $helpBlock = $controlGroup.find(".help-block").first(), $form = $this.parents("form").first(), validatorNames = [];
        ...
        destroy: function () {
          return this.each(function () {
            var $this = $(this), $controlGroup = $this.parents(".form-group, .checkbox").first(), $helpBlock = $controlGroup.find(".help-block").first();
            // remove our events
